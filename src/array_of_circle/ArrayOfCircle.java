...
public class ArrayOfCircle {
	...
	public void add(Circle element)
	{
		if(capacity==n)
		{
			Circle b[]=new Circle [capacity*2];
			capacity*=2;
			for(int i=0;i<n;i++)
				b[i]=a[i];
			a=b;
	...
	public void add(Circle element, int index)
	{
		if(capacity==n)
		{
			Circle b[]=new Circle [capacity*2];
	...
	public Circle getindex(int index)
	{
		if(index>=n||index<0)
		{
			System.out.println("Invalid");
	...
	public void set(Circle element,int index)
	{
		if(index>=n||index<0)
			System.out.println("invalid");
		else
